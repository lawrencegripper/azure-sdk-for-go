...
import original "github.com/Azure/azure-sdk-for-go/service/search/2015-02-28/searchindex"
...
type DocumentsClient = original.DocumentsClient
...
type SuggestParameters = original.SuggestParameters
...
func NewDocumentsClient() DocumentsClient {
	return original.NewDocumentsClient()
}
func NewDocumentsClientWithBaseURI(baseURI string) DocumentsClient {
	return original.NewDocumentsClientWithBaseURI(baseURI)
}
